...
a.storage[c],a.storage[c]^=a.storage[b],a.storage[b]^=a.storage[c],n=this.storage,swapNodes(c,b),setTimeout(function(){e(c)},stepDelay))};setTimeout(function(){n=this.storage.length;e(0)},stepDelay);return d}}var hp=new Heap;