document.getElementById("algIns2").style.backgroundColor="rgb(49, 226, 13)";
document.getElementById("algIns1").style.backgroundColor="#0d9be2";
document.getElementById("algIns1").style.color="#fff";
